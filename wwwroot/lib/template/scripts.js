...
function initCitybook() {
    ...
    $(document).on('submit', '#contactform', function () {
        ...
        $.post(a, {
            ...
            if (a.match("success")) {
                document.getElementById("message").innerHTML = "Message sended";
            }
    ...
    $("#subscribe").ajaxChimp({
        language: "eng",
        url: "https://chimpstatic.com/subscribe/post?u=d5c259979fbe06d64c1eb7dc9&amp;id=b3175aade75d3060af9f99434"
    });
